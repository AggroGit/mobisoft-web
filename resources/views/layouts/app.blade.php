...
<html lang="es" dir="ltr">
  <head>
    ...
    @yield('head')
    <!-- STYLES -->
    <link async href="{{ asset('css/common.css?v=0.9') }}" rel="stylesheet">
    <link async href="{{ asset('css/first.css?v=0.9') }}" rel="stylesheet">
    <link async href="{{ asset('css/menu.css?v=0.9') }}" rel="stylesheet">
