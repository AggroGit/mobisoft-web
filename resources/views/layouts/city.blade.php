...
<head>
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css" async rel="preload" as="style" onload="this.rel='stylesheets'">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js" async rel="preload" as="style" onload="this.rel='stylesheets'"></script>
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/js/bootstrap.min.js" async rel="preload" as="style" onload="this.rel='stylesheets'"></script>
  <!-- Letra Neon -->
