  ...
  <section id="portfolio" class="">
    ...
    <div class="portfolio-element" id="vuitntas">
      <div class="divided">
        ...
        <div class="divided-1-2 | slideanim">
          <img width="480" height="741" class="phone-img | unselectable | lazyload" data-src="/imagenes/apps/vuitantas.png" alt="Aplicación para restaurantes">
        </div>
    ...
    <div class="portfolio-element" id="collblanc">
      ...
      <div class="divided | ">
        ...
        <div class="divided-1-2 | slideanim">
          <img width="480" height="741" class="phone-img | unselectable | lazyload" data-src="/imagenes/apps/collblanc-2.png" alt="Aplicación Merco para Mercados">
        </div>
      </div>
    </div>
  ...
  <section id="proceso" class="top10">
    ...
    <div class="content-big | divided | top10 ">
      ...
      <div class="divided-1-2 | flex">
        <img width="480" height="356" class="unselectable | lazyload" data-src="/imagenes/desarrollo/definicion-objetivos.png" alt="Definición de objetivos">
      </div>
    </div>
    ...
    <div class="content-big | divided | reverse ">
      ...
      <div class="divided-1-2">
        <img width="480" height="432" class="unselectable | lazyload" data-src="/imagenes/desarrollo/usuario-objetivo.png" alt="Conceptualización de ideas en el desarrollo de aplicaciones">
      </div>
    </div>
    ...
    <div class="content-big | divided ">
      ...
      <div class="divided-1-2">
        <img width="480" height="353" class="unselectable | lazyload" data-src="/imagenes/desarrollo/ui-original.png" alt="Diseño de interfaz UI">
      </div>
    </div>
    ...
    <div class="content-big | divided | reverse ">
      ...
      <div class="divided-1-2">
        <img width="480" height="307" class="unselectable | lazyload" data-src="/imagenes/desarrollo/aplicaciones.png" alt="Processo de desarrollo de software">
      </div>
    </div>
    ...
    <div class="content-big | divided ">
      ...
      <div class="divided-1-2">
        <img width="480" height="440" class="unselectable | lazyload" data-src="/imagenes/desarrollo/aplicacion.png" alt="Testing y publicación de una Aplicación">
      </div>
    </div>
        ...
        <div class="contieneServicios">
          <div class="servicio">
            <div class="imagenServicio">
              <img width="138" height="100" class="lazyload" data-src="/imagenes/clientes/zincobs.png" alt="Zincobs" title="Zincobs logo">
            </div>
          ...
          <div class="servicio">
            <div class="imagenServicio">
              <img width="156" height="100" class="lazyload" data-src="/imagenes/clientes/aftermarketing.png" alt="AfterMarketing" title="Aftermarketing logo">
            </div>
            <div class="contieneServiciosInd">
              <h4>Marketing</h4>
              <ul>
    ...
    <div class="contieneClientela">
      <div class="content-big | contieneClientes">
        <div class="contiene_trust">
          <img width="223" height="60" class="lazyload" data-src="/imagenes/clientes/ajuntament_barcelona.png" alt="Ayuntamiento de Barcelona Open Data" title="Ayuntamiento de Barcelona logo">
        </div>
        <div class="contiene_trust">
          <img width="83" height="60" class="lazyload" data-src="/imagenes/clientes/zincobs.png" alt="Zincobs" title="Zincobs logo">
        </div>
        <div class="contiene_trust">
          <img width="93" height="60" class="lazyload" data-src="/imagenes/clientes/aftermarketing.png" alt="AfterMarketing" title="Aftermarketing logo">
        </div>
        <div class="contiene_trust">
          <img width="151" height="60" class="lazyload" data-src="/imagenes/clientes/barcelona_open_data.png" alt="Barcelona open data logo">
        </div>
        <div class="contiene_trust">
          <img width="38" height="60" class="lazyload" data-src="/imagenes/clientes/collblanc_icono.png" alt="Collblanc app" title="Collblanc app logo">
        </div>
      </div>
    </div>
  </section>
...
<section class="presupuestoAll | topped" id="presupuestar">
  <div class="coniteneimg-form ">
    <img width="400" height="107" data-src="/logos/mobisoft-logo.png" class="lazyload" alt="Mobility Software Solutions">
  </div>
